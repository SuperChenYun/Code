...
define('ADMIN_USERNAME','username'); 	// 缙哥哥：这里是你访问该界面的账号，可自行设定。
define('ADMIN_PASSWORD','password');  	// 缙哥哥：这里是你访问该界面的密码，可自行设定。
...
<div class="head">
	<h1 class="memcache">
		...
		<span class="nameinfo">Memcached.php by <a href="https://www.dujin.org/">缙哥哥的博客</a></span>
	</h1>
	<hr class="memcache">
</div>
<div class=content>
